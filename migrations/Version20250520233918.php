 ...
 */
final class Version20250520233918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE article DROP FOREIGN KEY FK_23A0E668386812A
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_23A0E668386812A ON article
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article CHANGE catogory_id category_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE article CHANGE category_id catogory_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
